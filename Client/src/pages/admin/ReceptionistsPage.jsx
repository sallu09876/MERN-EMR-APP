                    ...
                    <tr key={rec._id} style={{ animation: `fadeUp 0.3s ease ${i * 0.04}s both` }}>
                      <td>
                        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                          ...
                          <span style={{ fontWeight: 600, fontSize: "0.9rem", whiteSpace: "nowrap" }}>{rec.name}</span>
                        </div>
                      </td>
                      <td style={{ color: "var(--text-secondary)", fontSize: "0.875rem", whiteSpace: "nowrap" }}>{rec.email}</td>
                      <td>
                        <span style={{ background: "rgba(139,92,246,0.1)", color: "#7c3aed", padding: "0.25rem 0.75rem", borderRadius: "999px", fontSize: "0.78rem", fontWeight: 600, whiteSpace: "nowrap" }}>
                          Receptionist
                        </span>
                      </td>
                      <td>
